...
import { Wrench, Package, ChevronRight, Clock } from "lucide-react"
...
type FilterTab = 'active' | 'wade' | 'wayne' | 'parts' | 'ready' | 'atshop' | 'done'
...
export default function WorkOrdersDashboard() {
  ...
  const stats = {
    ...
    atshop: orders.filter(o => o.status === 'at-shop').length,
  }
  ...
  const TABS: { id: FilterTab; label: string; count?: number }[] = [
    ...
    { id: 'parts',  label: 'Parts',      count: stats.parts },
    { id: 'ready',  label: 'Ready',      count: stats.ready },
    { id: 'atshop', label: 'At Shop',    count: stats.atshop },
    { id: 'done',   label: 'Done' },
  ]
    ...
    <div className="max-w-3xl mx-auto px-3 pt-4 pb-2">
      ...
      <div className="grid grid-cols-6 gap-2 mb-4">
        {[
          ...
          { label: 'At Shop', val: stats.atshop,  cls: 'text-purple-600' },
        ].map(s => (
